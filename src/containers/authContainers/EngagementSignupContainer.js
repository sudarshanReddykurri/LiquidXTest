...
class EngagementSignupContainer extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <div>
        <Container component="main" maxWidth="xs">
          ...
          <div>
            ...
            <AppContext.Consumer>
              {({ emailID, isUserRegisteredForEngagement }) => (
                <Formik
                  initialValues={{
                    firstName: "",
                    lastName: "",
...
export default withRouter(
  withStyles(styles)(inject("rootTree")(observer(EngagementSignupContainer)))
);
